...
#### MVP-specific extraction:
    ...
    M1. What is the 'Minimum Success Path'?
    ...
    M4. What are the 3 core user journeys this MVP must support?
    M5. What does a user do in the first 5 minutes? What is the "aha moment"?

#### Output framework for MVP:

    - Feature Descriptions
    — Lean canvas (one-pager: problem / solution / UVP / channels / metrics)
    — Core user journey map (narrative, not diagram) / core workflow map
